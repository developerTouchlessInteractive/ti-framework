export declare class ServerEvent {
     ...
     */
    static readonly ACK_CONNECTION = "ACK_CONNECTION";
    /**
     ...
     */
    static readonly ACK_FLOW_INITIATION = "ACK_FLOW_INITIATION";
    /**
     * SERVER processing a flow initiation request
     */
    static readonly PROCESSING_REQUEST = "PROCESSING_REQUEST";
    /**
     * SERVER delivers created flow session information
     */
    static readonly SESSION_INFO = "SESSION_INFO";
    /**
    ...
    */
    static readonly PAYLOAD_PROCESSED = "PAYLOAD_PROCESSED";
    /**
    * SERVER is waiting for remote party to confim
    */
    static readonly AWAITING_REMOTE_CONFIRMATION = "AWAITING_REMOTE_CONFIRMATION";
    /**
    * SERVER recieved payload
    */
    static readonly ACK_PAYLOAD = "ACK_PAYLOAD";
    /**
    * SERVER relayed payload to remote
    */
    static readonly PAYLOAD_SENT_TO_REMOTE = "PAYLOAD_SENT_TO_REMOTE";
    /**
    * SERVER wants to halt the flow as there is a pending Action on SERVER side
    */
    static readonly FLOW_LOCK_ACTIVATE = "FLOW_LOCK_ACTIVATE";
    /**
    * SERVER wants to release the flow as the pending Action os complete
    */
    static readonly FLOW_LOCK_RELEASE = "FLOW_LOCK_RELEASE";
    /**
     * SERVER ack for customer's request for processing task completion.
     */
    static readonly ACK_TASK_COMPLETE_REQUEST = "ACK_TASK_COMPLETE_REQUEST";
    /**
    ...
    */
    static readonly STAGE_COMPLETE = "STAGE_COMPLETE";
    /**
    * SERVER confirms that Flow completed to CUSTOMER and CLIENT.
    */
    static readonly FLOW_COMPLETE = "FLOW_COMPLETE";
    /**
    * SERVER sent session completion
    */
    static readonly SESSION_COMPLETE = "SESSION_COMPLETE";
}
/**
...
export declare class CustomerEvent {
     ...
     * events / payload
     */
    static readonly FLOW_CONNECTION = "FLOW_CONNECTION";
    /**
    * CUSTOMER recieves a  payload
    */
    static readonly PAYLOAD_RECEIVED = "PAYLOAD_RECEIVED";
    /**
    ...
    */
    static readonly FLOW_CONNECTION_ERROR = "FLOW_CONNECTION_ERROR";
    /**
    ...
    */
    static readonly TASK_STARTED = "TASK_STARTED";
    /***
     * SDK- customer initiates a request to complete task. which is sent to
     * Server to be processed.
     */
    static readonly TASK_COMPLETE_REQUEST = "TASK_COMPLETE_REQUEST";
    /***
...
export declare class ClientEvent {
     ...
     */
    static readonly FLOW_INITIATION = "FLOW_INITIATION";
    /**
    ...
    */
     ...
     */
    static readonly FLOW_ESTABLISHED = "FLOW_ESTABLISHED";
    /**
    * CLIENT UNABLE to initiate flow
    */
    static readonly FLOW_INITIATION_ERROR = "FLOW_INITIATION_ERROR";
    /**
    ...
    */
     ...
     */
    static readonly SESSION_COMPLETE_REQUEST = "SESSION_COMPLETE_REQUEST";
}
export declare class TISdkErrorMessages {
    static readonly BAD_REQUEST = "Please Check your Request Data";
    /**
